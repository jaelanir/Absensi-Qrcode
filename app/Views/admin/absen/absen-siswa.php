      ...
      jQuery.ajax({
         ...
         success: function(response, status, xhr) {
            try {
               ...
               handleAjaxError(null, 'parse', 'Gagal menampilkan data', '#dataSiswa');
            }
         },
         error: function(xhr, status, thrown) {
            handleAjaxError(xhr, status, thrown, '#dataSiswa', 'Gagal memuat data absensi siswa');
         }
      });
